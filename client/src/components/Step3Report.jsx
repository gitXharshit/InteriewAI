...
function Step3Report({report}) {
  ...
  const questionScoreData = questionWiseScore.map((score, index) => ({
   ...
   if(finalScore >= 8){
      performanceText = "Excellent performance! You have demonstrated strong skills and knowledge in the interview.";
      shortTagLine = "Outstanding!";
   }else if(finalScore >= 5){
      performanceText = "Good job! You have shown a solid understanding of the subject matter, but there is room for improvement.";
      shortTagLine = "Well done!";
   }else{
      performanceText = "You may need to improve your skills and knowledge in certain areas. Consider reviewing the feedback and practicing more.";
  ...
  //  TITLE
   ...
   if(finalScore >= 8){
      ...
      advice= "Significant improvement required.Focus on structured thinking,clarity,and confident delivery.Practice answering aloud."
   }
